...
const FirstFloor = () => {
  ...
  // ✅ Default units
  const defaultUnits = [
    { id: 1, unitNo: "101", area: 348, date: "", downPayment: 0 },
    { id: 2, unitNo: "102", area: 329, date: "", downPayment: 0 },
    { id: 3, unitNo: "103", area: 329, date: "", downPayment: 0 },
    { id: 4, unitNo: "104", area: 179, date: "", downPayment: 0 },
    { id: 5, unitNo: "105", area: 273, date: "", downPayment: 0 },
    { id: 6, unitNo: "106", area: 740, date: "", downPayment: 0 },
    { id: 7, unitNo: "107", area: 474, date: "", downPayment: 0 },
    { id: 8, unitNo: "108", area: 762, date: "", downPayment: 0 },
    { id: 9, unitNo: "109", area: 761, date: "", downPayment: 0 },
    { id: 10, unitNo: "110", area: 485, date: "", downPayment: 0 },
    { id: 11, unitNo: "111", area: 479, date: "", downPayment: 0 },
    { id: 12, unitNo: "112", area: 497, date: "", downPayment: 0 },
    { id: 13, unitNo: "113", area: 470, date: "", downPayment: 0 },
    { id: 14, unitNo: "114", area: 453, date: "", downPayment: 0 },
    { id: 15, unitNo: "115", area: 453, date: "", downPayment: 0 },
    { id: 16, unitNo: "116", area: 470, date: "", downPayment: 0 },
    { id: 17, unitNo: "117", area: 283, date: "", downPayment: 0 },
    { id: 18, unitNo: "118", area: 582, date: "", downPayment: 0 },
    { id: 19, unitNo: "119", area: 650, date: "", downPayment: 0 },
    { id: 20, unitNo: "120", area: 385, date: "", downPayment: 0 },
    { id: 21, unitNo: "121", area: 385, date: "", downPayment: 0 },
    { id: 22, unitNo: "122", area: 407, date: "", downPayment: 0 },
    { id: 23, unitNo: "123", area: 401, date: "", downPayment: 0 },
    { id: 24, unitNo: "124", area: 296, date: "", downPayment: 0 },
    { id: 25, unitNo: "125", area: 461, date: "", downPayment: 0 },
    { id: 26, unitNo: "126", area: 496, date: "", downPayment: 0 },
    { id: 27, unitNo: "127", area: 518, date: "", downPayment: 0 },
    { id: 28, unitNo: "128", area: 518, date: "", downPayment: 0 },
    { id: 29, unitNo: "129", area: 387, date: "", downPayment: 0 },
    { id: 30, unitNo: "130", area: 462, date: "", downPayment: 0 },
  ];
    ...
    getFloorUnits("FirstFloor", (data) => {
      if (data.length > 0) {
        ...
        defaultUnits.forEach((u, index) => {
          ...
          addFloorUnit("FirstFloor", unitData, () => {
  ...
  const updateUnit = (id, field, value) => {
    const updated = units.map((u) => {
      if (u.id === id) {
        ...
        updateFloorUnit("FirstFloor", id, { [field]: value, total }, () => { });
  ...
  const saveUnitRecord = (unit) => {
    ...
    addUnitRecord(recordData, (success) => {
      if (success) {
        updateFloorUnit("FirstFloor", unit.id, { date: "", downPayment: 0, total: 0 }, () => {
          setUnits((prevUnits) =>
            prevUnits.map((u) =>
  ...
  const addNewUnit = () => {
    ...
    const lastNumber = lastUnit ? parseInt(lastUnit.unitNo) || 0 : 100;
    ...
    addFloorUnit("FirstFloor", newUnitData, (newId) => {
      if (newId) {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.row}>
      ...
      <TextInput
        ...
        editable={parseInt(item.unitNo) > 130}
      />
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>First Floor Units</Text>
