...
const SecondFloor = () => {
  ...
  // ✅ Default units
  const defaultUnits = [
    { id: 1, unitNo: "201", area: 348 },
    { id: 2, unitNo: "202", area: 329 },
    { id: 3, unitNo: "203", area: 329 },
    { id: 4, unitNo: "204", area: 199 },
    { id: 5, unitNo: "205", area: 273 },
    { id: 6, unitNo: "206", area: 740 },
    { id: 7, unitNo: "207", area: 474 },
    { id: 8, unitNo: "208", area: 752 },
    { id: 9, unitNo: "209", area: 761 },
    { id: 10, unitNo: "210", area: 485 },
    { id: 11, unitNo: "211", area: 479 },
    { id: 12, unitNo: "212", area: 497 },
    { id: 13, unitNo: "213", area: 470 },
    { id: 14, unitNo: "214", area: 453 },
    { id: 15, unitNo: "215", area: 453 },
    { id: 16, unitNo: "216", area: 470 },
    { id: 17, unitNo: "217", area: 283 },
    { id: 18, unitNo: "218", area: 582 },
    { id: 19, unitNo: "219", area: 506 },
    { id: 20, unitNo: "220", area: 385 },
    { id: 21, unitNo: "221", area: 385 },
    { id: 22, unitNo: "222", area: 407 },
    { id: 23, unitNo: "223", area: 401 },
    { id: 24, unitNo: "224", area: 302 },
    { id: 25, unitNo: "225", area: 461 },
    { id: 26, unitNo: "226", area: 296 },
    { id: 27, unitNo: "227", area: 518 },
    { id: 28, unitNo: "228", area: 518 },
    { id: 29, unitNo: "229", area: 387 },
    { id: 30, unitNo: "230", area: 462 },
  ];
  ...
  const loadUnits = () => {
    getFloorUnits("SecondFloor", (data) => {
      if (data.length > 0) {
        ...
        defaultUnits.forEach((u, index) => {
          ...
          addFloorUnit("SecondFloor", unitData, () => {
  ...
  const updateUnit = (id, field, value) => {
    const updated = units.map((u) => {
      if (u.id === id) {
        ...
        updateFloorUnit("SecondFloor", id, { [field]: value, total }, () => { });
  ...
  const saveUnitRecord = (unit) => {
    ...
    addUnitRecord(recordData, (success) => {
      if (success) {
        updateFloorUnit("SecondFloor", unit.id, { date: "", downPayment: 0, total: 0 }, () => {
          setUnits((prevUnits) =>
            prevUnits.map((u) =>
  ...
  const deleteUnit = (id) => {
    deleteFloorUnit("SecondFloor", id, () => {
  ...
  const addNewUnit = () => {
    ...
    const lastNumber = lastUnit ? parseInt(lastUnit.unitNo) || 0 : 200;
    ...
    addFloorUnit("SecondFloor", newUnitData, (newId) => {
      if (newId) {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.row}>
      ...
      <TextInput
        ...
        editable={parseInt(item.unitNo) > 230}
      />
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Second Floor Units</Text>
