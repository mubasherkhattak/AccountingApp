...
const FourthFLOORPAYMENT = () => {
  ...
  // ✅ Default units
  const defaultUnits = [
    { id: 1, unitNo: "401", area: 929 },
    { id: 2, unitNo: "402", area: 649 },
    { id: 3, unitNo: "403", area: 842 },
    { id: 4, unitNo: "404", area: 796 },
    { id: 5, unitNo: "405", area: 650 },
    { id: 6, unitNo: "406", area: 650 },
    { id: 7, unitNo: "407", area: 796 },
    { id: 8, unitNo: "408", area: 366 },
    { id: 9, unitNo: "409", area: 683 },
    { id: 10, unitNo: "410", area: 883 },
    { id: 11, unitNo: "411", area: 719 },
    { id: 12, unitNo: "412", area: 666 },
    { id: 13, unitNo: "413", area: 593 },
    { id: 14, unitNo: "414", area: 628 },
    { id: 15, unitNo: "415", area: 628 },
    { id: 16, unitNo: "416", area: 711 },
    { id: 17, unitNo: "417", area: 625 },
    { id: 18, unitNo: "418", area: 786 },
    { id: 19, unitNo: "419", area: 754 },
    { id: 20, unitNo: "420", area: 714 },
    { id: 21, unitNo: "421", area: 893 },
    { id: 22, unitNo: "422", area: 671 },
    { id: 23, unitNo: "423", area: 671 },
    { id: 24, unitNo: "424", area: 854 },
    { id: 25, unitNo: "425", area: 800 },
    { id: 26, unitNo: "426", area: 512 },
    { id: 27, unitNo: "427", area: 599 },
    { id: 28, unitNo: "428", area: 915 },
  ];
  ...
  const loadUnits = () => {
    getFloorUnits("FourthFloor", (data) => {
      if (data.length > 0) {
        ...
        defaultUnits.forEach((u, index) => {
          ...
          addFloorUnit("FourthFloor", unitData, () => {
  ...
  const updateUnit = (id, field, value) => {
    const updated = units.map((u) => {
      if (u.id === id) {
        ...
        updateFloorUnit("FourthFloor", id, { [field]: value, total }, () => { });
  ...
  const saveUnitRecord = (unit) => {
    ...
    addUnitRecord(recordData, (success) => {
      if (success) {
        updateFloorUnit("FourthFloor", unit.id, { date: "", downPayment: 0, total: 0 }, () => {
          setUnits((prevUnits) =>
            prevUnits.map((u) =>
  ...
  const deleteUnit = (id) => {
    deleteFloorUnit("FourthFloor", id, () => {
  ...
  const addNewUnit = () => {
    ...
    const lastNumber = lastUnit ? parseInt(lastUnit.unitNo) || 0 : 400;
    ...
    addFloorUnit("FourthFloor", newUnitData, (newId) => {
      if (newId) {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.row}>
      ...
      <TextInput
        ...
        editable={parseInt(item.unitNo) > 428}
      />
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Fourth Floor Units</Text>
...
export default FourthFLOORPAYMENT;
