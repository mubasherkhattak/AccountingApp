...
const NinthFLOORPAYMENT = () => {
  ...
  // ✅ Default units
  const defaultUnits = [
    { id: 1, unitNo: "901", area: 357 },
    { id: 2, unitNo: "902", area: 1067 },
    { id: 3, unitNo: "903", area: 1066 },
    { id: 4, unitNo: "904", area: 1042 },
    { id: 5, unitNo: "905", area: 607 },
    { id: 6, unitNo: "906", area: 652 },
    { id: 7, unitNo: "907", area: 500 },
    { id: 8, unitNo: "908", area: 500 },
    { id: 9, unitNo: "909", area: 500 },
    { id: 10, unitNo: "910", area: 500 },
    { id: 11, unitNo: "911", area: 698 },
    { id: 12, unitNo: "912", area: 891 },
    { id: 13, unitNo: "913", area: 799 },
    { id: 14, unitNo: "914", area: 787 },
    { id: 15, unitNo: "915", area: 770 },
    { id: 16, unitNo: "916", area: 781 },
    { id: 17, unitNo: "917", area: 789 },
    { id: 18, unitNo: "918", area: 943 },
    { id: 19, unitNo: "919", area: 428 },
    { id: 20, unitNo: "920", area: 469 },
    { id: 21, unitNo: "921", area: 375 },
    { id: 22, unitNo: "922", area: 301 },
    { id: 23, unitNo: "923", area: 915 },
    { id: 24, unitNo: "924", area: 1027 },
    { id: 25, unitNo: "925", area: 846 },
    { id: 26, unitNo: "926", area: 846 },
    { id: 27, unitNo: "927", area: 1187 },
    { id: 28, unitNo: "928", area: 1187 },
  ];
    ...
    getFloorUnits("NinthFloor", (data) => {
      if (data.length > 0) {
        ...
        defaultUnits.forEach((u, index) => {
          ...
          addFloorUnit("NinthFloor", unitData, () => {
  ...
  const updateUnit = (id, field, value) => {
    const updated = units.map((u) => {
      if (u.id === id) {
        ...
        updateFloorUnit("NinthFloor", id, { [field]: value, total }, () => { });
  ...
  const saveUnitRecord = (unit) => {
    ...
    addUnitRecord(recordData, (success) => {
      if (success) {
        updateFloorUnit("NinthFloor", unit.id, { date: "", downPayment: 0, total: 0 }, () => {
          setUnits((prevUnits) =>
            prevUnits.map((u) =>
  ...
  const addNewUnit = () => {
    ...
    const lastNumber = lastUnit ? parseInt(lastUnit.unitNo) || 0 : 900;
    ...
    addFloorUnit("NinthFloor", newUnitData, (newId) => {
      if (newId) {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.row}>
      ...
      <TextInput
        ...
        editable={parseInt(item.unitNo) > 928}
      />
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Ninth Floor Units</Text>
...
export default NinthFLOORPAYMENT;
