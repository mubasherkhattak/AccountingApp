...
const SeventhFLOORPAYMENT = () => {
  ...
  // ✅ Default units
  const defaultUnits = [
    { id: 1, unitNo: "701", area: 357 },
    { id: 2, unitNo: "702", area: 1067 },
    { id: 3, unitNo: "703", area: 1066 },
    { id: 4, unitNo: "704", area: 1001 },
    { id: 5, unitNo: "705", area: 607 },
    { id: 6, unitNo: "706", area: 652 },
    { id: 7, unitNo: "707", area: 500 },
    { id: 8, unitNo: "708", area: 500 },
    { id: 9, unitNo: "709", area: 500 },
    { id: 10, unitNo: "710", area: 500 },
    { id: 11, unitNo: "711", area: 698 },
    { id: 12, unitNo: "712", area: 891 },
    { id: 13, unitNo: "713", area: 799 },
    { id: 14, unitNo: "714", area: 787 },
    { id: 15, unitNo: "715", area: 770 },
    { id: 16, unitNo: "716", area: 781 },
    { id: 17, unitNo: "717", area: 789 },
    { id: 18, unitNo: "718", area: 943 },
    { id: 19, unitNo: "719", area: 869 },
    { id: 20, unitNo: "720", area: 581 },
    { id: 21, unitNo: "721", area: 915 },
    { id: 22, unitNo: "722", area: 1027 },
    { id: 23, unitNo: "723", area: 846 },
    { id: 24, unitNo: "724", area: 846 },
    { id: 25, unitNo: "725", area: 1187 },
    { id: 26, unitNo: "726", area: 1187 },
  ];
  ...
  const loadUnits = () => {
    getFloorUnits("SeventhFloor", (data) => {
      if (data.length > 0) {
        ...
        defaultUnits.forEach((u, index) => {
          ...
          addFloorUnit("SeventhFloor", unitData, () => {
  ...
  const updateUnit = (id, field, value) => {
    const updated = units.map((u) => {
      if (u.id === id) {
        ...
        updateFloorUnit("SeventhFloor", id, { [field]: value, total }, () => { });
  ...
  const saveUnitRecord = (unit) => {
    ...
    addUnitRecord(recordData, (success) => {
      if (success) {
        updateFloorUnit("SeventhFloor", unit.id, { date: "", downPayment: 0, total: 0 }, () => {
          setUnits((prevUnits) =>
            prevUnits.map((u) =>
  ...
  const deleteUnit = (id) => {
    deleteFloorUnit("SeventhFloor", id, () => {
  ...
  const addNewUnit = () => {
    ...
    const lastNumber = lastUnit ? parseInt(lastUnit.unitNo) || 0 : 700;
    ...
    addFloorUnit("SeventhFloor", newUnitData, (newId) => {
      if (newId) {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.row}>
      ...
      <TextInput
        ...
        editable={parseInt(item.unitNo) > 728}
      />
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Seventh Floor Units</Text>
...
export default SeventhFLOORPAYMENT;
