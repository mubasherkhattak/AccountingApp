...
const TenthFLOORPAYMENT = () => {
  ...
  // ✅ Default units
  const defaultUnits = [
    { id: 1, unitNo: "1001", area: 357 },
    { id: 2, unitNo: "1002", area: 1067 },
    { id: 3, unitNo: "1003", area: 1066 },
    { id: 4, unitNo: "1004", area: 1042 },
    { id: 5, unitNo: "1005", area: 607 },
    { id: 6, unitNo: "1006", area: 652 },
    { id: 7, unitNo: "1007", area: 500 },
    { id: 8, unitNo: "1008", area: 500 },
    { id: 9, unitNo: "1009", area: 500 },
    { id: 10, unitNo: "1010", area: 500 },
    { id: 11, unitNo: "1011", area: 698 },
    { id: 12, unitNo: "1012", area: 891 },
    { id: 13, unitNo: "1013", area: 799 },
    { id: 14, unitNo: "1014", area: 787 },
    { id: 15, unitNo: "1015", area: 770 },
    { id: 16, unitNo: "1016", area: 781 },
    { id: 17, unitNo: "1017", area: 789 },
    { id: 18, unitNo: "1018", area: 943 },
    { id: 19, unitNo: "1019", area: 428 },
    { id: 20, unitNo: "1020", area: 469 },
    { id: 21, unitNo: "1021", area: 375 },
    { id: 22, unitNo: "1022", area: 301 },
    { id: 23, unitNo: "1023", area: 915 },
    { id: 24, unitNo: "1024", area: 1027 },
    { id: 25, unitNo: "1025", area: 846 },
    { id: 26, unitNo: "1026", area: 846 },
    { id: 27, unitNo: "1027", area: 1187 },
    { id: 28, unitNo: "1028", area: 1187 },
  ];
    ...
    getFloorUnits("TenthFloor", (data) => {
      if (data.length > 0) {
        ...
        defaultUnits.forEach((u, index) => {
          ...
          addFloorUnit("TenthFloor", unitData, () => {
  ...
  const updateUnit = (id, field, value) => {
    const updated = units.map((u) => {
      if (u.id === id) {
        ...
        updateFloorUnit("TenthFloor", id, { [field]: value, total }, () => { });
  ...
  const saveUnitRecord = (unit) => {
    ...
    addUnitRecord(recordData, (success) => {
      if (success) {
        updateFloorUnit("TenthFloor", unit.id, { date: "", downPayment: 0, total: 0 }, () => {
          setUnits((prevUnits) =>
            prevUnits.map((u) =>
  ...
  const addNewUnit = () => {
    ...
    const lastNumber = lastUnit ? parseInt(lastUnit.unitNo) || 0 : 1000;
    ...
    addFloorUnit("TenthFloor", newUnitData, (newId) => {
      if (newId) {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.row}>
      ...
      <TextInput
        ...
        editable={parseInt(item.unitNo) > 1028}
      />
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Tenth Floor Units</Text>
...
export default TenthFLOORPAYMENT;
