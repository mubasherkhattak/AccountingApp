...
const SixthFLOORPAYMENT = () => {
  ...
  // ✅ Default units
  const defaultUnits = [
    { id: 1, unitNo: "601", area: 357 },
    { id: 2, unitNo: "602", area: 1067 },
    { id: 3, unitNo: "603", area: 1041 },
    { id: 4, unitNo: "604", area: 750 },
    { id: 5, unitNo: "605", area: 652 },
    { id: 6, unitNo: "606", area: 1100 },
    { id: 7, unitNo: "607", area: 500 },
    { id: 8, unitNo: "608", area: 500 },
    { id: 9, unitNo: "609", area: 500 },
    { id: 10, unitNo: "610", area: 598 },
    { id: 11, unitNo: "611", area: 709 },
    { id: 12, unitNo: "612", area: 720 },
    { id: 13, unitNo: "613", area: 720 },
    { id: 14, unitNo: "614", area: 720 },
    { id: 15, unitNo: "615", area: 781 },
    { id: 16, unitNo: "616", area: 781 },
    { id: 17, unitNo: "617", area: 789 },
    { id: 18, unitNo: "618", area: 943 },
    { id: 19, unitNo: "619", area: 860 },
    { id: 20, unitNo: "620", area: 581 },
    { id: 21, unitNo: "621", area: 909 },
    { id: 22, unitNo: "622", area: 820 },
    { id: 23, unitNo: "623", area: 840 },
    { id: 24, unitNo: "624", area: 930 },
    { id: 25, unitNo: "625", area: 1187 },
    { id: 26, unitNo: "626", area: 1187 },
  ];
    ...
    getFloorUnits("SixthFloor", (data) => {
      if (data.length > 0) {
        ...
        defaultUnits.forEach((u, index) => {
          ...
          addFloorUnit("SixthFloor", unitData, () => {
  ...
  const updateUnit = (id, field, value) => {
    const updated = units.map((u) => {
      if (u.id === id) {
        ...
        updateFloorUnit("SixthFloor", id, { [field]: value, total }, () => { });
  ...
  const saveUnitRecord = (unit) => {
    ...
    addUnitRecord(recordData, (success) => {
      if (success) {
        updateFloorUnit("SixthFloor", unit.id, { date: "", downPayment: 0, total: 0 }, () => {
          setUnits((prevUnits) =>
            prevUnits.map((u) =>
  ...
  const addNewUnit = () => {
    ...
    const lastNumber = lastUnit ? parseInt(lastUnit.unitNo) || 0 : 600;
    ...
    addFloorUnit("SixthFloor", newUnitData, (newId) => {
      if (newId) {
  ...
  const renderItem = ({ item }) => (
    <View style={styles.row}>
      ...
      <TextInput
        ...
        editable={parseInt(item.unitNo) > 615}
      />
  ...
  return (
    <View style={styles.container}>
      <Text style={styles.title}>Sixth Floor Units</Text>
...
export default SixthFLOORPAYMENT;
