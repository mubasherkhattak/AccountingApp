...
export default function SupplierFrom({ supplier, onSubmit, onClose }) {
    ...
    useEffect(() => {
        if (supplier) {
            ...
            setSalary(
                supplier.salary !== undefined && supplier.salary !== null
                    ? String(supplier.salary)
                    : '',
            );
        } else {
            setName('');
        ...
        <View style={styles.modalContainer}>
            <View style={styles.formContainer}>
                <Text style={styles.title}>
                    {supplier ? 'Update Supplier' : 'New Supplier'}
                </Text>
                ...
                <Text style={styles.label}>Monthly Payment (RS)</Text>
                <TextInput
                    style={styles.input}
